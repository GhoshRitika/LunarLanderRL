...
class Agent:
    ...
    def __init__(self, n_actions, input_dims, gamma=0.99, alpha=0.0003, gae_lambda=0.95,
        ...
        self.actorcritic = ActorCriticNetwork(n_actions, input_dims, alpha, chkpt_dir=self.chkpt_dir).to(self.device)
    ...
    def learn(self):
        ...
        for _ in range(self.n_epochs):
            ...
            for batch in batches:
                ...
                #Not sure if the detach if messing with the values
                # lambda_ = F.softplus(self.log_lambda_.detach())
